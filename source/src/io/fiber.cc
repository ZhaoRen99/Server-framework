...
void Fiber::swapOut() {
  ...
  // SYLAR_LOG_DEBUG(g_logger) << "change fiber with" <<
  // Scheduler::GetMainFiber()->GetFiberId();
...
void Fiber::setState(State s) { m_state = s; }
